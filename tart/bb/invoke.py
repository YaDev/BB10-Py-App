...
from tart.bb._wrap import _func, _register_funcs
from tart.bb.bps import _dll, bps_event_t
...
navigator_invoke_invocation_set_file_transfer_mode = _func(c_int, POINTER(navigator_invoke_invocation_t),
...
navigator_invoke_invocation_set_perimeter = _func(c_int, POINTER(navigator_invoke_invocation_t),
...
navigator_invoke_invocation_get_perimeter = _func(navigator_invoke_perimeter_type_t,
                                                  POINTER(navigator_invoke_invocation_t))
...
navigator_invoke_query_set_action_type = _func(c_int, POINTER(navigator_invoke_query_t),
                                               navigator_invoke_query_action_type_t)
navigator_invoke_query_set_perimeter = _func(c_int, POINTER(navigator_invoke_query_t),
                                             navigator_invoke_perimeter_type_t)
...
navigator_invoke_event_get_query_result_action = _func(POINTER(navigator_invoke_query_result_action_t),
                                                       POINTER(bps_event_t), c_int)
...
navigator_invoke_query_result_action_get_default_target = _func(c_char_p,
                                                                POINTER(navigator_invoke_query_result_action_t))
navigator_invoke_query_result_action_get_target_count = _func(c_int, POINTER(navigator_invoke_query_result_action_t))
navigator_invoke_query_result_action_get_target = _func(POINTER(navigator_invoke_query_result_target_t),
                                                        POINTER(navigator_invoke_query_result_action_t), c_int)
...
navigator_invoke_query_result_target_get_type = _func(navigator_invoke_target_type_t,
                                                      POINTER(navigator_invoke_query_result_target_t))
navigator_invoke_query_result_target_get_perimeter = _func(navigator_invoke_perimeter_type_t,
                                                           POINTER(navigator_invoke_query_result_target_t))
