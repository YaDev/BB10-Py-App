...
hu_AESCCMStarAuthEncrypt = _func(c_int, sb_Params, sb_Key, c_size_t, c_char_p, c_size_t, c_char_p, c_size_t, c_char_p,
                                 c_size_t, c_char_p, sb_GlobalCtx)
hu_AESCCMStarAuthDecrypt = _func(c_int, sb_Params, sb_Key, c_size_t, c_char_p, c_size_t, c_char_p, c_size_t, c_char_p,
                                 c_size_t, c_char_p, sb_GlobalCtx)
hu_AESCCMAuthEncrypt = _func(c_int, sb_Params, sb_Key, c_size_t, c_char_p, c_size_t, c_char_p, c_size_t, c_char_p,
                             c_size_t, c_char_p, sb_GlobalCtx)
hu_AESCCMAuthDecrypt = _func(c_int, sb_Params, sb_Key, c_size_t, c_char_p, c_size_t, c_char_p, c_size_t, c_char_p,
                             c_size_t, c_char_p, sb_GlobalCtx)
